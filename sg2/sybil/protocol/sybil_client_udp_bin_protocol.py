...
class SybilClientUdpBinProtocol(DatagramProtocol):
	...
	struct.pack_into('LH'+str(longueur)+'s',buf,0,TIME,longueurTotale,line)
	self.transport.write(buf,(self.server_host,self.server_port))
